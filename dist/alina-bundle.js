...
(function (global, factory) {
    ...
    var AlinaComponent$1 = /** @class */ (function (_super) {
        ...
        AlinaComponent$1.prototype.addChild = function (template, render) {
            this.root.tpl().addChild(template, render);
        };
        AlinaComponent$1.prototype.setChild = function (template, render) {
            this.root.tpl().setChild(template, render);
        };
        AlinaComponent$1.prototype.replace = function (template, render) {
            this.root.tpl().replace(template, render);
        };
        return AlinaComponent$1;
    }(Component));
    var rootNode$1 = typeof (document) === 'undefined' ? null : document;
    var Document$1 = rootNode$1 &&
        new NodeContext(rootNode$1, null).ext(StandardExt);
